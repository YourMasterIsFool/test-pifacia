...
class SubTaskController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validated = SubTaskData::from($request);
        } catch (\Exception $e) {
    ...
    public function show(string $id)
    {
        ...
        return $this->successResponse($this->service->detail($id), "Succesfully get SubTask");
    }
    ...
    public function destroy(string $id)
    {
        ...
        return $this->successResponse($this->service->delete($id), "Succesfully delete SubTask");
    }
